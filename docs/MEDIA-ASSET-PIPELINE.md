...
- **Resolved**: ZIP export (both Web Package ZIP and the project package) is now real — see the per-export-mode table above. **SCORM export remains entirely unimplemented.**
