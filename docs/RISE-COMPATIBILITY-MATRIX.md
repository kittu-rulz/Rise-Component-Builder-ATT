...
| Iframe snippet (`<iframe srcdoc="...">`) pasted into Rise's **Code › Add code** block | **Confirmed** | Manually tested in both the Rise authoring preview and a published Rise 360 course — see `docs/COMPATIBILITY-RESULTS.md` (2026-08-07). Rise's block editor preserves the pasted `srcdoc` attribute and the nested iframe renders and responds to interaction correctly. |
