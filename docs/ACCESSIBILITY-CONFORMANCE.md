...
| Video Player | ✅ Automated | Same base pattern as Interactive Learning Audio's play/scrub controls, plus the native `<video controls>` element's own built-in keyboard support as a fallback. |
